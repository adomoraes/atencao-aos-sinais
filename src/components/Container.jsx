		...
		<>
			<div className='bg-primary gap-5 p-4 lg:px-28 grid-cols-1 sm:grid-cols-2 grid-rows-3 grid'>
				...
				<div className='order-2 text-primary'>
					<div class='p-2 mb-3 w-max text-2xl tracking-wide text-white bg-pink-700 font-semibold'>
						Conheça o Câncer Renal
					</div>
					<h3 class='block mt-1 text-lg leading-tight font-medium'>O que é?</h3>
					<p class='mt-2'>
						...
						arterial. <span class='referrer'>[3]</span>
					</p>
					<p class='mt-2'>
					...
					<a
						href='#'
						title='Saiba Mais'
						class='p-2 mt-3 block w-max uppercase text-md tracking-wide text-white bg-pink-700 font-semibold hover:underline'>
						Saiba Mais
					</a>
				</div>
				<div className='sm:order-3 order-4 text-primary'>
					<h3 class='block mt-1 text-lg leading-tight font-medium'>Sintomas</h3>
					<p class='mt-2'>
				...
				<div className='sm:order-5 order-6 text-primary'>
					<h3 class='block mt-1 text-lg leading-tight font-medium'>
						Diagnóstico
					</h3>
					<p class='mt-2'>
